...
const EditEmployeePage: React.FC = () => {
  ...
  const breadcrumbItems = [
    ...
    { title: employeeDisplayName ? t('employee:edit_page.breadcrumb_title_with_name', { name: employeeDisplayName }) : t('employee:edit_page.breadcrumb_title') }
  ];

  return (
    <PageContainer
      title={employeeDisplayName 
        ? t('employee:edit_page.title_with_name', { name: employeeDisplayName }) 
