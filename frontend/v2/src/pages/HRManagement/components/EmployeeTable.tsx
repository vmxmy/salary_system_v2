...
const EmployeeTable: React.FC<EmployeeTableProps> = ({
  ...
  useEffect(() => {
    if (employees && employees.length > 0) {
      console.log({t('hr:auto_____5be591')}, employees[0]);
      console.log({t('hr:auto_____5be591')}, Object.keys(employees[0]));
      ...
      console.log({t('hr:auto___position_name_haspositionname__5be591')});
      console.log({t('hr:auto___actual_position_name_hasactualpositionname__5be591')});
      console.log({t('hr:auto___bank_name_hasbankname__5be591')});
      console.log({t('hr:auto___bank_account_number_hasbankaccount__5be591')});
    }
  }, [employees]);
