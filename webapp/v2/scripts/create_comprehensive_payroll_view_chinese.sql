...
SELECT 
    ...
    COALESCE((pe.deductions_details->'MEDICAL_PERSONAL_AMOUNT'->>'amount')::numeric, 0.00) as "医疗保险个人缴纳金额",
    COALESCE((pe.deductions_details->'MEDICAL_PERSONAL_TOTAL'->>'amount')::numeric, 0.00) as "医疗保险个人应缴总额",
