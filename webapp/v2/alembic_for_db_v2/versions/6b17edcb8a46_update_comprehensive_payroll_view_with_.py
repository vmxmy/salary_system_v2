...
def upgrade() -> None:
    """Upgrade schema - 更新 v_comprehensive_employee_payroll 视图包含所有薪资组件字段"""
    
    print("🔄 正在更新 v_comprehensive_employee_payroll 视图...")
    ...
    print("✅ 成功更新 v_comprehensive_employee_payroll 视图，包含所有薪资组件字段")
