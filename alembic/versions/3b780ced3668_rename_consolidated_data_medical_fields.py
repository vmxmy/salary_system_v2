"""rename_consolidated_data_medical_fields

Revision ID: 3b780ced3668
Revises: 16e83cdf1c84
Create Date: 2025-05-07 17:10:07.494739
...
revision: str = '3b780ced3668'
down_revision: Union[str, None] = '16e83cdf1c84'
...
def upgrade() -> None:
    ...
    op.alter_column('consolidated_data', 'med_total_employer_contribution',
                    new_column_name='med_medic_total_employer_contribution',
                    schema='staging')
    op.alter_column('consolidated_data', 'med_total_employee_contribution',
...
def downgrade() -> None:
    ...
    op.alter_column('consolidated_data', 'med_medic_total_employer_contribution',
                    new_column_name='med_total_employer_contribution',
                    schema='staging')
    op.alter_column('consolidated_data', 'med_medic_total_employee_contribution',
                    new_column_name='med_total_employee_contribution',
                    schema='staging')
