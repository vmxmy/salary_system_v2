"""create_regular_employee_salary_view

Revision ID: 39e112379eaa
Revises: 1a1e8747b7cc
Create Date: 2025-05-07 16:00:58.491350
...
revision: str = '39e112379eaa'
down_revision: Union[str, None] = '1a1e8747b7cc'
...
def downgrade() -> None:
    """Downgrade schema."""
    # 删除视图
    op.execute("DROP VIEW IF EXISTS public.正编人员工资信息表;")
